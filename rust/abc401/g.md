...
Source: https://atcoder.jp/contests/abc401/tasks/abc401_g
...
高橋くんたちはそれぞれ移動をした後、この $N$ 個のボタンを**一斉に**押したいです。 各ボタンは、そのボタンがある座標にいる高橋くんだけが押すことができます。 ボタンが存在する座標に到達してからボタンを押すのに必要な時間は $0$ 秒です。
